...
record* Data::reverse_list(record* index)
{
...
int Data::add_record(string input_name, string input_address, int input_birth_year, string input_phone_number)
{
    struct record *temp = NULL;
...
int Data::print_record(string input_name)
{
    struct record *index = start;
...
int Data::modify_record(string input_name, string input_address, string input_phone_number)
{
    struct record *index = start;
...
int Data::delete_record(string input_name)
{
    struct record *temp = NULL;
    struct record *index = start;
    struct record *previous = NULL;
    ...
    { 
        std::cout << records_deleted << " records of " << input_name << " deleted.\n";
    }
    std::cout << "--------------------\n";
    return 1;
}

void Data::reverse_list()
{
    std::cout << "--------------------\n";
    if (start == NULL) {
        std::cout << "The Database is empty. Therefore, no records can be reversed.\n";
